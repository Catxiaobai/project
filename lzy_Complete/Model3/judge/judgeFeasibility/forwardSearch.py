...
#迁移信息
from obtain_efsm_info import getSecondOppositeBranch, targetBranch
class TranWithInfo:
    conflictTran = {}
...
class PartialList:
    ...
    def __init__(self, targetBranch, starttime):
        ...
        self.targetBranchSrcList = getSecondOppositeBranch(self.targetBranch) #返回目标分值起始节点
