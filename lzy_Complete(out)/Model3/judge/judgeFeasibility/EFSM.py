...
class GA:
    ...
    def genome(self, vartype, genomeLen= 0):
        ...
        for i in range(genomeLen):
            boolFlag=0
            for key, value in vartype.items():
    ...
    def fitnessScore(self, geneFitness):
        ...
        for i, value in geneFitness.items():
    ...
    def basicSurvive(self, oldFitness, mutatedFitness, mutatedGenomes, surviveRate=0.8):
        ...
        for i, value in oldFitness.items():
...
############################################################
    ...
    def vDefUseList(self, currTransition):
        ...
        vlist=[]
        eventlist=[]
        for stat in statements.split(";")[:1]:
        ...
        for old in oldDefVar:           
            if oldDefVar.count(old)>1:
                for i in range(oldDefVar.count(old)-1):
                    ...
                    for vtran,vdict in self.currPathTranVarDict.items():
                        if vtran in currPath:
                            for ftran,fdict in self.currPathTranFuncDict.items():
                                if ftran==vtran:                                  
                                    flag=0                                    
                ...
                for vtran,vdict in self.currPathTranVarDict.items():
                    if vtran==currTrans:
                      ...
                      #####deal with event variables######
                        ...
                        break
            i=i+1
        for vtran,vdict in self.repeatTranVarDict.items():
            tempvdict=[]
            tempvdict.extend(vdict['eventVdef'])
            while tempvdict!=[]:
                self.originalDef.append(tempvdict.pop(0))
...
###################defined and used variables anaysis for a path##################
    ...
    def VarNumDefOnPath(self, currPath):
        ...
        while (temp<len(currPath)):
            ...
            for vtran,vdict in self.tranVarDict.items():
                if vtran==currTrans:
    ...
    def condNumOnPath(self, currPath):
        ...
        while (temp<len(currPath)):
            ...
            for vtran,vdict in self.tranVarDict.items():
                if vtran==currTrans:
                    for ftran,fdict in self.tranFuncDict.items():
                        if ftran==currTrans:
                            tempFlag=1
                            if (fdict['condFunc']!=[''] and fdict['condFunc']!=[]):
                                condNum=condNum+1
                    ...
                    while tempvdict!=[]:
                        ...
                        if tempVar in vdict['condVuse']:
                            ...
                            if (nexti<len(currPath)):
                                ...
                                for vvtran,vvdict in self.tranVarDict.items():
                                    if vvtran==nextTrans:
...
################# test generation for path that length <= 100 ########
    ...
    def testGen(self,path):
        ...
        pathList = [['T1', 'T4', 'T6', 'T23'],\
                    ['T1', 'T2', 'T4', 'T5', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T5', 'T23'], \
                    ['T1', 'T4', 'T5', 'T7', 'T12', 'T15', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T6', 'T8', 'T10', 'T7', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T7', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T7', 'T12', 'T15', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T7', 'T14', 'T15', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T6', 'T8', 'T10', 'T8', 'T17', 'T22', 'T17', 'T22', 'T18', 'T22', 'T10', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T5', 'T8', 'T17', 'T21', 'T17', 'T21', 'T10', 'T7', 'T12', 'T15', 'T9', 'T7', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T7', 'T13', 'T15', 'T9', 'T7', 'T9', 'T7', 'T12', 'T15', 'T9', 'T7', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T7', 'T13', 'T15', 'T13', 'T15', 'T9', 'T7', 'T9', 'T7', 'T9', 'T7', 'T9', 'T7', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T5', 'T8', 'T17', 'T21', 'T17', 'T21', 'T19', 'T21', 'T10', 'T7', 'T13', 'T15', 'T9', 'T7', 'T9', 'T7', 'T12', 'T15', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T7', 'T13', 'T15', 'T9', 'T7', 'T9', 'T7', 'T12', 'T15', 'T12', 'T15', 'T14', 'T15', 'T12', 'T15', 'T9', 'T23'], \
                    ['T1', 'T2', 'T4', 'T5', 'T7', 'T12', 'T15', 'T9', 'T7', 'T9', 'T7', 'T13', 'T15', 'T12', 'T15', 'T14', 'T15', 'T14', 'T15', 'T12', 'T15', 'T9', 'T7', 'T9', 'T7', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T7', 'T13', 'T15', 'T13', 'T15', 'T9', 'T7', 'T9', 'T7', 'T9', 'T7', 'T9', 'T8', 'T17', 'T21', 'T10', 'T8', 'T10', 'T23'], \
                    ['T1', 'T2', 'T2', 'T4', 'T5', 'T7', 'T9', 'T8', 'T10', 'T7', 'T13', 'T15', 'T9', 'T7', 'T13', 'T15', 'T9', 'T7', 'T9', 'T7', 'T12', 'T15', 'T9', 'T8', 'T10', 'T7', 'T9', 'T8', 'T10', 'T23']]

        pathList0 = [['T1', 'T2', 'T2', 'T2', 'T3'], \
                    ['T1', 'T4', 'T6', 'T7', 'T11', 'T16', 'T9', 'T8', 'T20', 'T22', 'T10', 'T23'], \
                    ['T1', 'T4', 'T5', 'T7', 'T12', 'T15', 'T13', 'T15', 'T14', 'T15', 'T9', 'T8', 'T19', 'T21', 'T17', 'T21', 'T18', 'T21', 'T10', 'T23'],['T1','T4','T5','T8']]

        pathList4 = [['T1', 'T2', 'T2', 'T2', 'T3'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T6', 'T7', 'T11', 'T16', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T6', 'T8', 'T20', 'T22', 'T10', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T5', 'T7', 'T12', 'T15', 'T14', 'T15', 'T13', 'T15', 'T9', 'T23'], \
                    ['T1', 'T2', 'T2', 'T2', 'T4', 'T5', 'T8', 'T17', 'T21', 'T19', 'T21', 'T18', 'T21', 'T10', 'T23']]

        # PathList1 = [['T1', 'T4', 'T5', 'T7', 'T12', 'T16']]
...
#            i=i+1
#######################################################
# inputfile= r'model/resultModel.txt'
...
if __name__ == '__main__':
    ...
    inputfile = filepath+"resultModel.txt"
    SM = efsmFromFile(inputfile)
    # SM.allPathNum()
