<template>
  <div id="sample">
    ...
    <textarea style="width:100%;height:250px" v-model="savedModelText" />
    <p class="box bg-info">This is a <a href="https://vuejs.org">Vue.js</a> sample.</p>
    <p>
    ...
    <p>
      That component also raises two events: "model-changed" corresponding to <a>Model.addChangedListener</a>, and "changed-selection" for the
      "ChangedSelection" <a>DiagramEvent</a>.
    </p>
    <p>
      ...
      methods such as <a>Model.setDataProperty</a>, and an "updateDiagramFromData" method. The latter permits data changes without calling Model methods to
      notify Diagrams showing the model, but at the cost of not being able to support undo and redo.
    </p>
  </div>
</template>
...
Vue.component('diagram', {
  ...
  mounted: function() {
    ...
    myDiagram.linkTemplate = $(go.Link, { relinkableFrom: true, relinkableTo: true }, $(go.Shape), $(go.Shape, { toArrow: 'OpenTriangle' }))
