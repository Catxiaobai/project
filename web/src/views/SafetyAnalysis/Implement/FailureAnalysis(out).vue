    ...
    <el-card style="margin-left: 10px;margin-right: 10px">
      <div class="divForm">
        ...
        >
          ...
          <el-table-column label="软件失效原因" align="center">
            <template slot-scope="scope">
              <textarea placeholder="输入软件失效原因" v-model="scope.row.content1" v-show="test3"></textarea>
            </template>
          </el-table-column>
          <el-table-column label="软件失效影响" align="center">
            <el-table-column label="本层影响" align="center">
              <template slot-scope="scope">
                <textarea placeholder="输入本层影响" v-model="scope.row.content2" v-show="test3"></textarea>
              </template>
            </el-table-column>
            <el-table-column label="上一层影响" align="center">
              <template slot-scope="scope">
                <textarea placeholder="输入上一层影响" v-model="scope.row.content3" v-show="test3"></textarea>
              </template>
            </el-table-column>
            <el-table-column label="系统影响" align="center">
              <template slot-scope="scope">
                <textarea placeholder="输入系统影响" v-model="scope.row.content4" v-show="test3"></textarea>
              </template>
            </el-table-column>
          </el-table-column>
          <el-table-column label="影响等级" align="center">
            <template slot-scope="scope">
